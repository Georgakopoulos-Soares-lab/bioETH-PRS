...
Manuscript reviewed: `RTR_and_paper/manuscript/source/bioeth_prs.tex`  
...
- [x] Create a revision branch from snapshot `2d6f21d4560db77da026aa7d5043e5f1e789288c`.
      ...
      `RTR_and_paper/manuscript/source/bioeth_prs.tex`, and this plan with no code changes.
...
- [x] No manuscript file is edited until Stage A is complete. `RTR_and_paper/manuscript/source/bioeth_prs.tex` is committed
...
- [x] `R2.6-C1` `validation/independent_prs_reference.py`, standard library only. Implements
      ...
      comparison. Written from `RTR_and_paper/manuscript/source/bioeth_prs.tex` and `docs/design.md`; does not import,

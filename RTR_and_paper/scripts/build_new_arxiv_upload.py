...
SOURCE_FIGURES = PAPER_ROOT / "archive" / "generated_figure_drafts"
DEFAULT_OUTPUT = PAPER_ROOT / "archive" / "new_arxiv_upload"
...
The contracts process larger models in repeated groups. The Streaming calculations at
100, 500, 1,000, and 5,000 variants were evaluated only in the local simulation; no
Sepolia Streaming result is reported.
"""
    ...
    print(f"wrote arXiv package sources to {output.relative_to(REPO_ROOT)}")

...
def build() -> None:
    ...
    add_comment_response(
        ...
        [
            ...
            "The manuscript now describes this order directly in the text: genotype checks and effect-allele alignment, encryption, contract calculation, release to the intended requester, and decoding.",
